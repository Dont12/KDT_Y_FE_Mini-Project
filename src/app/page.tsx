...
const HomePage = () => {
  ...
  const mainIcons = [
    ...
    { icon: 'svg/main-icon/guest-house.svg', label: '게스트하우스' },
    { icon: 'svg/main-icon/condo.svg', label: '콘도' },
    { icon: 'svg/main-icon/youth-hostel.svg', label: '유스호스텔' },
    { icon: 'svg/main-icon/minbak.svg', label: '민박' },
    { icon: 'svg/main-icon/homestay.svg', label: '홈스테이' },
    {
      icon: 'svg/main-icon/serviced-residences.svg',
      label: '서비스드레지던스',
    },
      ...
      pensions: [
        {
          ...
          rating: 4.2,
          price: 90000,
          image: 'svg/main-icon/youth-hostel.svg',
        },
        {
          name: '서귀포 펜션 2',
          rating: 3.8,
      ...
      pensions: [
        {
          ...
          rating: 4.2,
          price: 90000,
          image: 'svg/main-icon/guest-house.svg',
        },
        {
          name: '제주 펜션 2',
          rating: 3.8,
      ...
      pensions: [
        {
          ...
          rating: 4.2,
          price: 90000,
          image: 'svg/main-icon/serviced-residences.svg',
        },
        {
          name: '서울/강남 호텔 2',
          rating: 3.8,
